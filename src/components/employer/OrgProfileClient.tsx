              ...
              <form onSubmit={handleSave} className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:border-[#7C3AED]/50"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      placeholder="https://"
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:border-[#7C3AED]/50 placeholder:text-slate-700"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:border-[#7C3AED]/50 resize-none placeholder:text-slate-700"
                  />
                </div>
                ...
                <button
                  ...
                  style={{ background: "linear-gradient(135deg, #7C3AED, var(--color-primary))", boxShadow: "0 4px 16px rgba(124,58,237,0.3)" }}
                >
          ...
          >
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-[#7C3AED]/50 placeholder:text-slate-700"
              />
              <button
                type="submit"
                disabled={saving}
