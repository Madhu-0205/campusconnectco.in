...
export default function NotificationsPopover({
 ...
 exit={{ opacity: 0, y: 8 }}
 className="absolute right-0 mt-3 w-[360px] bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden z-50"
 >

 {/* Header */}
 <div className="px-4 py-3 border-slate-100 flex items-center justify-between bg-slate-50/50">
 ...
 className={`p-4 border-slate-50 cursor-pointer hover:bg-slate-50 :bg-surface-3/50 transition-colors ${!n.isRead ?"bg-blue-50/50" :""}`}
 >
 <div className="flex justify-between items-start gap-2">
 <h4 className={`${!n.isRead ?"font-bold" :"font-semibold text-slate-600"}`}>
 {n.title}
 </h4>
 ...
 {/* Footer */}
 <div className="p-2 border-slate-100 bg-slate-50/50">
 <Button
 variant="ghost"
