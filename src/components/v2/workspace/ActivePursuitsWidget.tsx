...
export const ActivePursuitsWidget = ({ pursuits }: ActivePursuitsWidgetProps) => {
 ...
 <div className="p-4 rounded-xl bg-surface-2 border border-transparent hover:border-primary/50 transition-colors group">
 <div className="flex justify-between items-start mb-2">
 <div className="w-10 h-10 rounded-lg bg-surface border border-border flex items-center justify-center font-black text-foreground shadow-sm">
