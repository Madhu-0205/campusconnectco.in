...
export const WorkspaceWelcome = ({ userName, focusText, careerScore }: WorkspaceWelcomeProps) => {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl bg-surface-2 border border-border p-6 md:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 h-full w-full col-span-1 md:col-span-2 lg:col-span-3">
        {/* Ambient Glow */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 blur-[100px] rounded-full pointer-events-none" />
        
        <div className="relative z-10 space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent border border-border text-xs font-bold uppercase tracking-wider text-muted-foreground mb-2">
        ...
        <div className="relative z-10 flex items-center gap-4 bg-background border border-border rounded-2xl p-4 shadow-sm shrink-0">
