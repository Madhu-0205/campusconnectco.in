...
const CATEGORY_COLORS: Record<AnnouncementItem["category"], { bg: string; text: string; border: string; glow: string }> = {
  ...
  "Campus Announcement":  { bg: "rgba(124,58,237,0.1)",  text: "#8B5CF6", border: "rgba(124,58,237,0.25)",  glow: "rgba(124,58,237,0.08)"  },
}
...
const PRIORITY_STYLES: Record<NonNullable<AnnouncementItem["priority"]>, { bg: string; text: string; border: string }> = {
  ...
  "Featured":      { bg: "rgba(124,58,237,0.15)",  text: "#C4B5FD", border: "rgba(124,58,237,0.35)"  },
    ...
    <article
      ...
      style={{
        background: isFeatured
          ? "linear-gradient(135deg, rgba(124,58,237,0.12) 0%, rgba(17,17,39,0.9) 50%, rgba(8,8,15,0.95) 100%)"
          : "rgba(17,17,39,0.6)",
        border: `1px solid ${isFeatured ? "rgba(124,58,237,0.3)" : "rgba(255,255,255,0.06)"}`,
        boxShadow: isFeatured ? "0 8px 32px rgba(124,58,237,0.12)" : "0 2px 16px rgba(0,0,0,0.2)",
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.borderColor = isFeatured ? "rgba(124,58,237,0.5)" : colorStyle.border
      }}
      onMouseLeave={e => {
        e.currentTarget.style.transform = "translateY(0)"
        e.currentTarget.style.boxShadow = isFeatured ? "0 8px 32px rgba(124,58,237,0.12)" : "0 2px 16px rgba(0,0,0,0.2)"
        e.currentTarget.style.borderColor = isFeatured ? "rgba(124,58,237,0.3)" : "rgba(255,255,255,0.06)"
      }}
    >
