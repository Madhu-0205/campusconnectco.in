...
function EmptyState({ category }: { category: string }) {
 ...
 style={{ background:"rgba(31,169,113,0.08)", border:"1px solid rgba(31,169,113,0.2)" }}
 >
...
export default function AnnouncementSection() {
 ...
 style={{
 background:"radial-gradient(ellipse 60% 40% at 50% 0%, rgba(31,169,113,0.05) 0%, transparent 70%)",
 }}
 />
 <div
 className="absolute top-0 left-0 right-0 h-px"
 style={{ background:"linear-gradient(90deg, transparent, rgba(31,169,113,0.4), rgba(6,182,212,0.3), transparent)" }}
 />
 ...
 className="relative inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold whitespace-nowrap transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary shrink-0"
 style={{
 color: isActive ?"#fff" :"var(--text-3)",
 background: isActive ?"rgba(31,169,113,0.85)" :"rgba(255,255,255,0.03)",
 border: `1px solid ${isActive ?"rgba(31,169,113,0.6)" :"rgba(255,255,255,0.07)"}`,
 boxShadow: isActive ?"0 2px 12px rgba(31,169,113,0.3)" :"none",
 ...
 <Link
 href="/announcements"
 className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
 style={{
 ...
 onMouseEnter={e => {
 e.currentTarget.style.background ="rgba(31,169,113,0.2)"
 e.currentTarget.style.borderColor ="rgba(31,169,113,0.45)"
 }}
 onMouseLeave={e => {
 e.currentTarget.style.background ="rgba(31,169,113,0.1)"
 e.currentTarget.style.borderColor ="rgba(31,169,113,0.25)"
 }}
 >
