...
export default function MonthlyComparison() {
 ...
 .filter((d) => d.name.includes(currentMonthName))
 ...
 <YAxis dataKey="name" type="category" stroke="#64748b" width={100} tick={{ fontSize: 12, fontWeight: 800 }} axisLine={false} tickLine={false} />
 <Tooltip
 ...
 <Cell key={`cell-${index}`} fill={index === 1 ? '#ff4d1c' : '#334155'} />
 ))}
 </Bar>
 </BarChart>
 </ResponsiveContainer>
