...
"w-full flex items-center gap-4 p-4 rounded-3xl transition-all group relative",
 isActive ?"bg-foreground text-background shadow-xl shadow-primary/20" :"hover:bg-(--surface-2)"
 )}
 >
...
"px-6 py-4 rounded-4xl text-sm font-bold shadow-xl",
 ...
 <div className="absolute inset-0 bg-primary/5 blur-2xl rounded-full group-focus-within:bg-accent transition-all" />
 <div className="relative flex items-center bg-[#18181F] border border-white/5 group-focus-within:border-primary/30 rounded-3xl p-1.5 shadow-2xl transition-all">
