        ...
        <Link href={`/gigs/${gig.id}`}>
            ...
            >
                <div className="flex items-start justify-between mb-4">
                    ...
                    <span
                        className={`px-2 py-1 rounded-lg font-bold ${gig.status === "OPEN" ? "bg-green-100 dark:bg-green-900/30 dark:text-green-400" : "bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400" }`}
                    >
                        {gig.status}
                    </span>
                </div>
                            ...
                            >
                                ...
                                {activeFiltersCount > 0 && (
                                    <button
                                        ...
                                        className="mt-4 flex items-center gap-2 px-4 py-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors font-medium"
                                    >
                                        <X size={16} />
                                        Clear all filters
                                    </button>
