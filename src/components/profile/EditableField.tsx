...
export function EditableField({
 ...
 onClick={handleSave}
 disabled={saving}
 className="p-2 px-4 bg-foreground text-background hover:bg-foreground/90 rounded-xl text-xs font-black shadow-lg shadow-primary/20 active:scale-95 transition-all flex items-center gap-2"
 >
