      ...
      {!mounted ? (
        ...
        <div
          ...
          style={{
            ...
            border: `1px dashed ${hovered ? "rgba(124,58,237,0.45)" : "rgba(124,58,237,0.2)"}`,
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, rgba(124,58,237,0.6), rgba(245,158,11,0.5), rgba(124,58,237,0.6))" }}
          />
          ...
          <div className="relative z-10 p-6 space-y-4">
            ...
            <div className="pt-1">
              <Link
                href={href}
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl font-bold text-xs transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2"
                style={{
                  background: "var(--grad-brand)",
                  color: "#ffffff",
                  boxShadow: hovered ? "0 4px 20px rgba(124,58,237,0.35)" : "0 2px 10px rgba(124,58,237,0.2)",
