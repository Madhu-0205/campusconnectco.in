...
export function Hero3D() {
 ...
 if (!isMounted) {
 return <div className="absolute inset-0 -z-10 opacity-60 bg-linear-to-br from-primary/10 to-pink-50/10" />
 }

 if (!hasWebGL) {
 return (
 <div className="absolute inset-0 -z-10 opacity-60 bg-linear-to-br from-primary/20 to-pink-50/20" />
 );
 }
