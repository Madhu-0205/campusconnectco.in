...
export function CollegeDropdown({
 ...
 className="w-full bg-[#111116] border border-border text-left p-3.5 rounded-xl focus:ring-2 focus:ring-[#1FA971]/50 focus:border-[#1FA971]/50 outline-none transition-all flex items-center justify-between"
 >
