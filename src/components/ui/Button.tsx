...
"bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
 outline:
"border border-border bg-background shadow-sm hover:bg-surface-2 hover:text-foreground",
 secondary:
"bg-surface-2 text-foreground shadow-sm hover:bg-surface-3",
 ghost:"hover:bg-surface-2 hover:text-foreground",
 link:"text-primary underline-offset-4 hover:underline",
 glass:
"bg-white/70 backdrop-blur-md border border-white/20 hover:bg-white/90 text-foreground transition-all duration-300 shadow-sm",
 },
 size: {
