...
export default function CollegeSearchList({
 ...
 autoComplete="off"
 className="w-full pl-9 pr-9 py-2.5 rounded-xl text-sm font-medium text-white placeholder-slate-600 outline-none transition-all focus:ring-2 focus:ring-[#1FA971]/50"
 style={{
 ...
 onClick={onCantFind}
 whileTap={{ scale: 0.97 }}
 className="w-full flex items-center justify-between gap-2 px-4 py-3 rounded-xl border text-sm font-semibold transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
 style={{
 background:"rgba(31,169,113,0.04)",
 borderColor:"rgba(31,169,113,0.15)",
 color:"#8B5CF6",
 }}
 onMouseEnter={e => {
 (e.currentTarget as HTMLElement).style.background ="rgba(31,169,113,0.08)"
 ;(e.currentTarget as HTMLElement).style.borderColor ="rgba(31,169,113,0.3)"
 }}
 onMouseLeave={e => {
 (e.currentTarget as HTMLElement).style.background ="rgba(31,169,113,0.04)"
 ;(e.currentTarget as HTMLElement).style.borderColor ="rgba(31,169,113,0.15)"
 }}
 >
