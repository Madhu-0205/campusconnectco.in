...
export default function LocationPermissionCard({
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(124,58,237,0.08) 0%, rgba(17,17,39,0.7) 100%)",
      ...
      <div className="relative z-10 space-y-5">
        ...
        <div className="flex flex-col gap-2.5">
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm text-white transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 disabled:opacity-60"
            style={{
          ...
          <motion.button
            ...
            disabled={isRequesting}
            whileTap={{ scale: 0.97 }}
            className="w-full flex items-center justify-center gap-1.5 py-3 rounded-xl text-sm font-semibold transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 disabled:opacity-50"
            style={{
              color: "#64748B",
