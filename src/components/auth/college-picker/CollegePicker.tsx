...
export default function CollegePicker({ value, onChange, userId }: CollegePickerProps) {
 ...
 aria-expanded={open}
 className="w-full flex items-center gap-2 text-left p-3.5 rounded-xl border outline-none transition-all focus-visible:ring-2 focus-visible:ring-[#1FA971]/50 cursor-pointer"
 style={{
 background:"rgba(255,255,255,0.03)",
 borderColor: value ?"rgba(31,169,113,0.4)" :"rgba(255,255,255,0.08)",
 boxShadow: value ?"0 0 0 1px rgba(31,169,113,0.15)" :"none",
 }}
 >
 <GraduationCap
 ...
 style={{
 background:
"linear-gradient(90deg, rgba(31,169,113,0.6), rgba(99,102,241,0.4), transparent)",
 }}
 />
