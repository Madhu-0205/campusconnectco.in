...
const TYPE_COLORS: Record<string, { bg: string; text: string }> = {
 ...
 Pharmacy: { bg:"rgba(31,169,113,0.12)", text:"#C4B5FD" },
...
export default function CollegeCard({
 ...
 whileTap={{ scale: 0.98 }}
 className="w-full text-left group relative flex items-center gap-3 p-3 rounded-xl border transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
 style={{
 background: isSelected ?"rgba(31,169,113,0.12)" :"rgba(255,255,255,0.02)",
 borderColor: isSelected ?"rgba(31,169,113,0.4)" :"rgba(255,255,255,0.06)",
 boxShadow: isSelected ?"0 2px 12px rgba(31,169,113,0.15)" :"none",
 }}
