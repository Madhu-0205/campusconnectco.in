...
const INPUT_CLS =
"w-full bg-white/4 border border-white/8 text-white placeholder-slate-600 p-3 rounded-xl text-sm focus:ring-2 focus:ring-[#1FA971]/50 focus:border-[#1FA971]/50 outline-none transition-all font-medium"
...
export default function ManualCollegeForm({
 ...
 style={{ background:"rgba(31,169,113,0.1)", border:"1px solid rgba(31,169,113,0.2)" }}
 >
 ...
 type="submit"
 disabled={loading}
 className="w-full py-3.5 rounded-xl font-black text-sm text-white flex items-center justify-center gap-2 transition-all disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary mt-2"
 style={{
 background:"linear-gradient(135deg, #1FA971 0%, #6366F1 100%)",
 boxShadow:"0 4px 16px rgba(31,169,113,0.25)",
 }}
 >
 {loading ? (
 <>
