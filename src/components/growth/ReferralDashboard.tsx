...
const TIER_CONFIG = [
 ...
 { min: 25, max: Infinity, name:"Legend",color:"#1FA971", bg:"rgba(31,169,113,0.1)", border:"rgba(31,169,113,0.25)", badge:"👑", bonus:"₹250" },
]
...
export function ReferralDashboard({}: { userId: string }) {
 ...
 style={{
 background: copied ?"rgba(16,185,129,0.15)" :"linear-gradient(135deg, #1FA971, #FF4500)",
 ...
 style={{ background:"rgba(31,169,113,0.06)", border:"1px solid rgba(31,169,113,0.15)" }}
 >
 ...
 style={{ background:"rgba(31,169,113,0.2)", color:"#A78BFA" }}
 >
 {step}
 </span>
