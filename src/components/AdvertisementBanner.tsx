...
function AdvertisementBannerSkeleton() {
  return (
    <div className="w-full rounded-2xl overflow-hidden relative" style={{ minHeight: "90px", background: "rgba(17,17,39,0.4)", border: "1px dashed rgba(124,58,237,0.15)" }}>
      ...
      {!mounted ? (
        ...
        <div
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.boxShadow = "0 4px 32px rgba(124,58,237,0.12)"
