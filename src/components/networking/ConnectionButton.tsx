...
"inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-150 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed";
 ...
 className="absolute top-full mt-1 right-0 z-10 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface border border-white/10 font-medium text-[#F43F5E] hover:bg-[#F43F5E]/10 transition-colors whitespace-nowrap shadow-xl"
 >
 ...
 onClick={sendRequest}
 disabled={loading}
 className={`${baseBtn} ${sz} bg-[#1FA971] text-white hover:bg-[#1FA971]/90 hover:shadow-[0_0_20px_rgba(31,169,113,0.5)]`}
 >
 {loading ? (
 <Loader2 size={compact ? 13 : 15} className="animate-spin" />
 ) : (
