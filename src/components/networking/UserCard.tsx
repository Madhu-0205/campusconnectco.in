...
export default function UserCard({
  ...
  if (compact) {
    return (
      <div className="flex items-center justify-between gap-4 p-4 rounded-xl border border-white/[0.07] bg-[#131929]/80 hover:border-white/15 transition-all">
  ...
  return (
    <div className="group p-5 rounded-2xl border border-white/[0.07] bg-[#131929]/80 backdrop-blur-md hover:border-[#7C3AED]/30 hover:shadow-[0_8px_40px_rgba(124,58,237,0.12)] hover:-translate-y-0.5 transition-all duration-200">
      {/* Header */}
      ...
      {skillNames.length > 0 && (
        <div className="flex flex-wrap gap-1.5 mb-4">
          {skillNames.slice(0, 4).map((skill) => (
            <span
              key={skill}
              className="px-2.5 py-1 rounded-lg bg-[#7C3AED]/10 border border-[#7C3AED]/20 text-[10px] font-medium"
            >
              {skill}
            </span>
          ))}
