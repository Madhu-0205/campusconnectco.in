...
"Hiring analytics",
 ...
 icon: Building2,
 color:"text-[#1FA971]",
 bg:"bg-[#1FA971]/15 border-[#1FA971]/35",
 glow:"rgba(31,169,113,0.15)",
 recommended: true,
 cta:"Start Growth",
 ctaStyle:"",
...
export default function EmployerUpgradePage() {
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#1FA971]/15 border border-[#1FA971]/30 text-[#A78BFA] text-[10px] font-black uppercase tracking-widest mb-6">
 <Sparkles size={12} />
 ...
 Hire India&apos;s <span style={{ background:"linear-gradient(135deg, var(--color-primary), #1FA971)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>Best Student Talent</span>
 </h1>
 ...
 { icon: Brain, label:"AI-Powered Matching", color:"text-[#1FA971]" },
 ...
 plan.recommended ?"ring-2 ring-[#1FA971]/50" :""
 }`}
 style={{
 ...
 <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest" style={{ background:"linear-gradient(90deg, #1FA971, var(--color-primary))", color:"white" }}>
 Most Popular
 </span>
 </div>
 )}
 ...
 style={
 plan.recommended
 ? { background:"linear-gradient(135deg, #1FA971, var(--color-primary))", color:"white", boxShadow:"0 4px 20px rgba(31,169,113,0.3)" }
 : {}
 }
 >
 {plan.cta}
