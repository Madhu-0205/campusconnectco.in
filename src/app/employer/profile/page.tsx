...
export default async function EmployerProfilePage() {
 ...
 <div className="w-16 h-16 rounded-2xl bg-[#1FA971]/10 border border-[#1FA971]/20 flex items-center justify-center mx-auto mb-5">
 ...
 GROWTH: { label:"Growth", color:"text-[#1FA971]", bg:"bg-[#1FA971]/10 border-[#1FA971]/20" },
 ...
 :"linear-gradient(135deg, rgba(31,169,113,0.4), rgba(255,77,28,0.3))",
 }}
 />
 ...
 const color = TECH_STACK_COLORS[tech] ||"#1FA971"
 return (
 <span
 key={tech}
 ...
 <div className="w-8 h-8 rounded-lg bg-[#1FA971]/20 flex items-center justify-center text-xs font-black text-[#A78BFA]">
