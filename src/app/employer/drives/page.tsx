...
export default async function CampusDrivesPage() {
 ...
 {[
 { label:"Total Drives", value: stats.total, icon: PlayCircle, color:"text-[#1FA971]", bg:"bg-[#1FA971]/10 border-[#1FA971]/20" },
 ...
 <div
 key={drive.id}
 className="p-5 rounded-2xl hover:border-[#1FA971]/30 transition-all group"
 style={{ background:"var(--color-surface)", border:"1px solid var(--color-border)" }}
 >
...
"Conversion analytics dashboard",
 ...
 <span className="text-[10px] px-2 py-0.5 bg-[#1FA971]/10 border border-[#1FA971]/20 text-[#A78BFA] rounded-full font-bold">
 {i < 5 ?"Tier 1" :"Tier 2"}
 </span>
 </div>
 ))}
