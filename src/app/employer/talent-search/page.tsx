    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#7C3AED]/15 border border-[#7C3AED]/30 text-[#A78BFA] text-[10px] font-black uppercase tracking-widest mb-3">
              <Brain size={12} />
        ...
        >
          <div className="absolute inset-0 blur-3xl opacity-20" style={{ background: "radial-gradient(circle at center, rgba(124,58,237,0.8), transparent)" }} />
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-2xl bg-[#7C3AED]/20 border border-[#7C3AED]/40 flex items-center justify-center mx-auto mb-4">
