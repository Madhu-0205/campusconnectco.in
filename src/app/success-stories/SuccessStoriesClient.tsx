...
const AGGREGATE_STATS = [
 { value:"10,000+", label:"Students Placed", icon: GraduationCap, color:"text-[#1FA971]" },
...
"datePublished":"2024-01-01",
 ...
 <div className="absolute -top-40 left-1/3 w-96 h-96 blur-[150px] rounded-full" style={{ background:"rgba(31,169,113,0.1)" }} />
 ...
 <span style={{ background:"linear-gradient(135deg, #1FA971, #FF4500)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>
 ...
 style={activeTab === tab ? { background:"linear-gradient(135deg, #1FA971, var(--color-primary, #FF4500))" } : {}}
 >
 ...
 <div
 key={story.id}
 className="p-6 rounded-3xl flex flex-col hover:border-[#1FA971]/40 transition-all group"
 style={{ background:"var(--color-surface)", border:"1px solid var(--color-border)" }}
 >
 ...
 <Quote size={12} className="inline mr-1 text-[#1FA971]" />
 {story.quote}
 </p>
 </div>
 ...
 {story.tags.map((t) => (
 <span key={t} className="text-[9px] font-bold px-1.5 py-0.5 bg-[#1FA971]/10 border border-[#1FA971]/20 text-[#A78BFA] rounded-full">
 {t}
 </span>
 ))}
 </div>
 ...
 activeCategory === cat
 ?"bg-[#1FA971]/20 border-[#1FA971]/40 text-[#A78BFA]"
 ...
 <div
 key={story.id}
 className="p-5 rounded-2xl flex gap-4 hover:border-[#1FA971]/30 transition-all"
 style={{ background:"var(--color-surface)", border:"1px solid var(--color-border)" }}
 >
 ...
 <span className="text-[10px] font-black px-2 py-0.5 rounded-full bg-[#1FA971]/10 border border-[#1FA971]/20 text-[#A78BFA]">
 {cs.plan} Plan
 </span>
 </div>
 ...
 <blockquote className="text-slate-300 text-sm leading-relaxed mb-6 pl-4 border-l-2 border-[#1FA971]/50">
 <Quote size={14} className="text-[#1FA971] mb-1" />
 {cs.quote}
 </blockquote>
 ...
 style={{ background:"linear-gradient(135deg, rgba(31,169,113,0.15), rgba(255,69,0,0.1))", border:"1px solid rgba(31,169,113,0.2)" }}
 >
 <div className="absolute inset-0 pointer-events-none">
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 blur-[100px] rounded-full" style={{ background:"rgba(31,169,113,0.1)" }} />
 </div>
 ...
 style={{ background:"linear-gradient(135deg, #1FA971, #FF4500)", boxShadow:"0 6px 24px rgba(31,169,113,0.35)" }}
 >
