...
export default async function CareerPathSEOPage({ params }: Props) {
 ...
 How to Become a <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-400 to-primary-light">{career.title}</span>
 </h1>
 ...
 <div
 key={idx}
 className="bg-surface/60 border border-white/5 rounded-2xl p-5 hover:border-amber-500/20 transition-all flex items-start gap-4"
 >
 ...
 <div
 key={internship.id}
 className="bg-surface/80 border border-white/5 rounded-2xl p-4 space-y-3 hover:border-primary/20 transition-all"
 >
 <div>
 ...
 <div className="bg-gradient-to-br from-amber-600/10 to-primary-light/5 border border-amber-500/10 rounded-3xl p-5 space-y-2.5">
