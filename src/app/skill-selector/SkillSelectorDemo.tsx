...
export default function SkillSelectorDemo() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-indigo-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/20 px-4 py-14">
            <div className="mx-auto max-w-2xl space-y-10">

                {/* ── Page header ── */}
                <div className="text-center">
                    <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-indigo-200 dark:border-indigo-800 bg-indigo-50 dark:bg-indigo-950/50 px-4 py-1.5 font-semibold uppercase tracking-widest text-indigo-600 dark:text-indigo-400">
                        ⚡ UI/UX Pro Max
                    </div>
                ...
                <div className="rounded-2xl border border-white/10/60 bg-[#111116] p-6 shadow-sm">
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {["Multi-select", "Autocomplete", "Keyboard ↑↓ ↵", "Backspace removes", "Animated badges", "ARIA combobox", "Form-ready"].map((f) => (
                                <span key={f} className="rounded-full bg-white/5 px-3 py-1 font-medium text-slate-500 dark:text-slate-400">
                                    {f}
                                </span>
                            ))}
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full rounded-xl bg-indigo-600 py-3 font-semibold text-white shadow-sm transition hover:bg-indigo-700 active:scale-[.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 disabled:opacity-50"
                    ...
                    {/* Form output */}
                    {submitted && (
                        <div className="mt-5 rounded-xl bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 p-4 animate-[scaleIn_200ms_ease-out_both]">
                            <p className="mb-2 font-semibold uppercase tracking-wider text-green-700 dark:text-green-400">
                                ✅ Form submitted — skill IDs
                            </p>
                            <pre className="whitespace-pre-wrap break-all text-green-800 dark:text-green-300 font-mono">
                ...
                <div className="rounded-2xl border border-white/10/60 bg-[#111116] p-6 shadow-sm space-y-4">
                    <div>
                        <h2 className="font-bold text-slate-800 dark:text-slate-100">Variant — Max 3 selections</h2>
                ...
                <div className="rounded-2xl border border-white/10/60 bg-[#111116] p-6 shadow-sm space-y-4">
                    <div>
                        <h2 className="font-bold text-slate-800 dark:text-slate-100">Variant — Disabled state</h2>
                ...
                <div className="rounded-2xl border border-white/10 p-5">
                    ...
                    <div className="grid grid-cols-2 gap-x-6 text-slate-600 dark:text-slate-400">
                        {[
                            ["↑ / ↓", "Navigate dropdown"],
                            ["↵ Enter", "Toggle skill"],
