    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white p-6">
        <div className="max-w-md w-full text-center bg-slate-900 border border-slate-800 rounded-2xl p-8">
          ...
          <button onClick={() => router.push("/client-hub")} className="px-6 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-full">
            Return to Hub
          </button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 h-fit space-y-6">
            ...
            <button
              ...
              disabled={paying || !app}
              className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-800 disabled:text-slate-500 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-indigo-500/20 active:scale-[0.98]"
            >
