...
export default async function ReferralPage() {
 ...
 <div className="absolute top-0 left-1/3 w-96 h-96 blur-[150px] rounded-full" style={{ background:"rgba(31,169,113,0.07)" }} />
 ...
 >
 <div className="absolute -right-8 -top-8 w-32 h-32 blur-3xl rounded-full bg-[#1FA971]/20" />
 <div className="flex items-center gap-3 mb-3 relative z-10">
 <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl" style={{ background:"rgba(31,169,113,0.2)" }}>
 🎁
 </div>
 <div>
