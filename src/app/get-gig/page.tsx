...
export default function GetGigPage() {
    ...
    return (
        <div className="min-h-screen bg-white/2 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300 pb-20">
            {/* Header / Hero Section */}
            <div className="bg-[#111116] border-white/10 pt-8 pb-12 px-6 lg:px-8 relative overflow-hidden">
                <div className="absolute top-[-50%] right-[-10%] w-[50%] h-[150%] bg-electric/5 dark:bg-electric/10 blur-[100px] rounded-full pointer-events-none" />

                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                        <div className="max-w-2xl">
                            <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4">
                                Find the perfect <span className="text-transparent bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">Freelance Gig</span>
                            </h1>
                        ...
                        <div className="w-full md:w-96 relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3.5 bg-white/5 border-none rounded-2xl focus:outline-none focus:ring-2 focus:ring-electric shadow-sm hover:shadow-md transition-all font-medium text-slate-900 dark:text-white"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 items-center">
                        ...
                        {categories.map(cat => (
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-full font-bold transition-all ${activeCategory === cat ? "bg-slate-900 dark:bg-white dark:text-slate-900 shadow-md scale-105" : "bg-white/5 text-slate-600 dark:text-slate-300 border border-white/10 hover:border-slate-300 dark:hover:border-slate-600" }`}
                            >
                                {cat}
                            </button>
                        ))}
            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-8 py-8 flex flex-col xl:flex-row gap-8">
                ...
                <div className="flex-1 space-y-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <div className="flex items-center gap-2 bg-white/5 px-3 py-1.5 rounded-xl border border-white/10">
                                ...
                                <select
                                    ...
                                    className="bg-transparent border-none font-bold text-slate-900 dark:text-white focus:outline-none cursor-pointer p-0"
                                >
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-xl font-bold transition-colors ${showFilters ? 'bg-electric' : 'bg-white/5 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-white/10'}`}
                            >
                                ...
                                <div className="bg-[#111116] p-6 rounded-2xl border border-white/10 shadow-sm grid grid-cols-1 sm:grid-cols-3 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                placeholder="e.g. 500"
                                                className="w-full pl-9 pr-3 py-2 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-electric shadow-sm font-bold text-slate-900 dark:text-white"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <label className="font-black uppercase tracking-wider text-slate-500">Duration / Type</label>
                                        <select className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-electric shadow-sm font-bold text-slate-900 dark:text-white">
                                    ...
                                    <div className="flex items-end justify-end">
                                        <button
                                            ...
                                            className="font-bold text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors underline"
                                        >
                                            Clear all filters
                                        </button>
                                    </div>
                    ...
                    {loading && gigs.length === 0 ? (
                        ...
                        <div className="text-center py-20 bg-[#111116] rounded-4xl border border-dashed">
                            ...
                            <h3 className="font-black text-slate-900 dark:text-white mb-2">No gigs found</h3>
                    ...
                    {hasMore && !loading && gigs.length > 0 && (
                        <div className="flex justify-center pt-6">
                            <Button
                                ...
                                variant="outline"
                                className="font-bold border-white/10 hover:border-electric/50 text-slate-700 dark:text-slate-300 rounded-xl px-8 h-12"
                            >
                                Load More Gigs
                            </Button>
                        </div>
                ...
                <div className="w-full xl:w-80 shrink-0 space-y-6">
                    <div className="bg-linear-to-b from-indigo-50 to-white dark:from-indigo-950/40 dark:to-slate-900 border border-indigo-100 dark:border-indigo-900/50 rounded-3xl p-6 shadow-sm relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-10 dark:opacity-20 pointer-events-none">
                            <Sparkles size={100} />
                        </div>

                        <div className="flex items-center gap-3 mb-6 relative z-10">
                            <div className="h-10 w-10 rounded-xl bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20">
                                <Sparkles size={20} />
                            </div>
                            <div>
                                <h3 className="font-black text-slate-900 dark:text-white">Smart Matches</h3>
                                <p className="font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Powered by AI</p>
                            </div>
                        </div>
                            ...
                            {loadingMatches ? (
                                ...
                                smartMatches.map((match) => (
                                    <motion.div
                                        key={match.id}
                                        whileHover={{ y: -2 }}
                                        className="bg-white dark:bg-slate-950 border border-white/5 dark:border-slate-800 rounded-2xl p-4 shadow-sm hover:shadow-md hover:border-indigo-200 dark:hover:border-indigo-800/50 transition-all cursor-pointer group"
                                        onClick={() => handleApply(match.id)}
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            <span className="bg-indigo-50 dark:bg-indigo-900/30 dark:text-indigo-300 text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md flex items-center gap-1">
                                        ...
                                        <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors mb-1 line-clamp-1">
                                            {match.title}
                                        </h4>
                                        <p className="text-slate-500 dark:text-slate-400 line-clamp-1 mb-3 font-medium">
                                            {match.poster?.name || "Verified Client"} • {match.tags || "General"}
                                        </p>

                                        <div className="font-bold text-slate-400 bg-white/2 dark:bg-slate-900 p-2 rounded-lg italic">
                                            &quot;{match.matchReason}&quot;
                                        </div>
                                    </motion.div>
                                ))
                        ...
                        <Button
                            variant="default"
                            className="w-full mt-6 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-xl"
                    ...
                    {/* Trust Banner */}
                    <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/50 rounded-3xl p-5 flex items-start gap-4">
                        <div className="h-8 w-8 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5">
                            <Check size={16} strokeWidth={3} />
                        </div>
                        <div>
                            <h4 className="font-bold dark:text-emerald-300 text-sm">Secure Escrow Payments</h4>
                            <p className="font-medium text-emerald-700/80 dark:text-emerald-500/80 mt-1 leading-relaxed">
        ...
        <div className="bg-[#111116] border border-white/10 rounded-3xl p-6 flex flex-col h-full hover:shadow-lg hover:border-electric/30 transition-all group">
            <div className="flex justify-between items-start gap-4 mb-3">
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    {isNew && (
                        <span className="bg-blue-100 dark:bg-blue-900/40 dark:text-blue-400 text-[10px] font-black uppercase tracking-wider px-2 py-1 rounded-md flex items-center gap-1">
                            <span role="img" aria-label="new">🔥</span> New
                        </span>
                    )}
                    {isPopular && !isNew && (
                        <span className="bg-amber-100 dark:bg-amber-900/40 dark:text-amber-400 text-[10px] font-black uppercase tracking-wider px-2 py-1 rounded-md flex items-center gap-1">
            ...
            <h3 className="font-black text-slate-900 dark:text-white mb-2 leading-tight group-hover:text-electric transition-colors line-clamp-2">
                {gig.title}
            </h3>

            <p className="font-medium text-slate-500 dark:text-slate-400 line-clamp-2 mb-5 flex-1">
                {gig.description}
            </p>

            <div className="flex flex-wrap items-center gap-4 font-bold text-slate-500 dark:text-slate-400 mb-6 bg-white/5/50 p-3 rounded-xl">
            ...
            <div className="flex items-center gap-3 pt-4 border-white/5 dark:border-slate-800 mt-auto">
                <Button
                    onClick={onApply}
                ...
                <button className="h-10 w-10 shrink-0 rounded-xl bg-white/5 hover:bg-slate-200 dark:hover:bg-slate-700 flex items-center justify-center text-slate-500 border border-white/10 transition-colors">
                    <Star size={18} />
                </button>
            </div>
        </div>
...
function GigSkeleton() {
    return (
        <div className="bg-[#111116] border border-white/5 dark:border-slate-800 rounded-3xl p-6 h-full space-y-4">
...
function MatchSkeleton() {
    return (
        <div className="bg-white/50 dark:bg-slate-950/50 border border-white/5 dark:border-slate-800 rounded-2xl p-4 space-y-3">
            <div className="flex justify-between">
