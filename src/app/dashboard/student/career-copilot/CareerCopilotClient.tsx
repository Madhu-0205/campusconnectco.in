...
export default function CareerCopilotPage() {
 ...
 >
 <div className="shrink-0 w-16 h-16 rounded-[24px] bg-surface-2 font-black text-2xl flex items-center justify-center shadow-xl z-10 border-[#111116] ring-4 ring-[#0a0a0f]">
 {idx + 1}
 </div>
