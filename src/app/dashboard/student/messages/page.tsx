                    ...
                    {contacts.map(contact => (
                        ...
                        >
                            <div className="relative shrink-0">
                                <div className="w-12 h-12 rounded-full bg-linear-to-br from-blue-400 to-purple-500 flex items-center justify-center font-bold text-lg">
                                    {contact.avatar}
                                </div>
                ...
                <div className={`flex flex-col bg-[#0a0a0f] relative ${!isMobileOverview ? 'flex' : 'hidden md:flex'}`}>
                    ...
                    <div className="h-16 px-4 py-2 border-white/10 bg-[#111116] flex items-center justify-between shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-400 to-purple-500 flex items-center justify-center font-bold text-sm">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 custom-scrollbar bg-[#0a0a0f] space-y-4">
                        ...
                        {messages.map((msg) => (
                            ...
                            >
                                <div className={`max-w-[85%] sm:max-w-[70%] px-4 py-2 relative shadow-sm group ${msg.sender_id === 0 ? 'bg-linear-to-br from-blue-600 to-purple-600 shadow-lg shadow-blue-500/10' : 'bg-white/5 text-white rounded-tl-none border border-white/5'}`}>
