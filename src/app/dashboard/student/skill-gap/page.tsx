                ...
                {result && (
                    ...
                    >
                        ...
                        <Card className="border-white/10 bg-[#111116] p-8 md:p-10 rounded-[32px] shadow-xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-48 h-48 bg-purple-500/5 blur-[50px] pointer-events-none" />
                            ...
                            <CardContent className="p-0 space-y-4">
                                {result.learningPlan.map((step, idx) => (
                                    <div key={idx} className="flex gap-4 p-5 rounded-2xl bg-white/2 border border-white/5 hover:bg-white/3 transition-all">
                                        <div className="w-8 h-8 rounded-lg bg-purple-500/20 border border-purple-500/30 text-purple-300 font-black text-xs flex items-center justify-center shrink-0">
                                            {idx + 1}
                                        </div>
