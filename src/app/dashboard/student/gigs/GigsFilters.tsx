...
const CATEGORIES = [
 ...
 { label:"Design", icon: Palette, color:"bg-primary/10 text-primary border-primary/20" },
...
export function GigsFilters() {
 ...
 <div className="absolute bottom-[-20%] right-[10%] w-48 h-48 bg-primary/15 blur-[60px] rounded-full" />
 </div>
