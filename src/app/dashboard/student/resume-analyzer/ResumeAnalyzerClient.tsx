...
export default function ResumeAnalyzerPage() {
 ...
 <div className="absolute bottom-0 left-0 w-60 h-60 bg-primary/20 blur-[80px] rounded-full pointer-events-none z-0" />
 ...
 <div className="relative w-52 h-52 flex items-center justify-center rounded-[3rem] border-white/10 bg-surface-2/80 backdrop-blur-2xl shadow-2xl overflow-hidden">
...
"relative group transition-all duration-500",
 ...
 >
 <div className="w-24 h-24 rounded-full bg-surface-2 border border-white/5 flex items-center justify-center mb-8 relative">
