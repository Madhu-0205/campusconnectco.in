        ...
        <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-wrap gap-2 pt-4">
                <button 
                    ...
                    className={`px-5 py-2.5 rounded-full font-bold transition-all flex items-center gap-2 text-sm ${activeTab === "all" ? "bg-slate-900 text-white shadow-lg shadow-slate-900/20" : "bg-white text-slate-600 hover:bg-slate-50 border border-slate-200"}`}
                >
