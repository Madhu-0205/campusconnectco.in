...
function InternshipCard({
 ...
 <div className="bg-linear-to-r from-orange-500 to-primary-light px-4 py-1 flex items-center gap-1.5">
 ...
 {/* Company avatar */}
 <div className="w-10 h-10 rounded-xl bg-linear-to-br from-orange-500 to-primary-light flex items-center justify-center font-black text-sm shrink-0 shadow-md">
 ...
 <button
 onClick={onShare}
 className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-surface-3 transition-all hover:scale-110"
 title="Share"
 >
 <Share2 size={14} />
 </button>
...
export default function InternshipsClient({ 
 ...
 Find Your Next <span className="text-transparent bg-linear-to-r from-orange-600 to-primary-light">Internship</span>
 </h1>
 ...
 <div className="bg-linear-to-r from-orange-500/5 via-primary/5 to-blue-500/5 border border-(--primary)/20 rounded-2xl p-4">
 <div className="flex items-center gap-2 mb-3">
 ...
 className="flex items-center gap-2 bg-(--surface) border border-white/10 rounded-xl px-3 py-2 min-w-max snap-start hover:border-orange-400/50 hover:shadow-sm transition-all"
 >
 <div className="w-6 h-6 rounded-lg bg-linear-to-br from-orange-500 to-primary-light flex items-center justify-center text-[10px] font-black shrink-0">
 {i.company.charAt(0)}
 </div>
 <div className="text-left">
 <p className="font-black text-white line-clamp-1">{i.title}</p>
