...
export default function PostGigPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto relative z-10 p-6">
            ...
            <div className="mb-8">
                <h2 className="text-3xl font-black mb-2 text-foreground tracking-tight">Post a New Gig</h2>
                <p className="text-muted-foreground font-medium">Find the perfect student for your task.</p>
            </div>

            <Card className="border border-white/20 dark:border-slate-800 shadow-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-[2.5rem] overflow-hidden">
                <div className="p-10">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="space-y-3">
                            ...
                            <input
                                ...
                                className="w-full px-6 py-4 rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 focus:bg-white dark:focus:bg-slate-800 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/50 outline-none transition-all font-bold text-foreground placeholder:text-slate-400"
                        ...
                        <div className="space-y-3">
                            ...
                            <textarea
                                ...
                                className="w-full px-6 py-4 rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 focus:bg-white dark:focus:bg-slate-800 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/50 outline-none transition-all font-medium text-foreground placeholder:text-slate-400 resize-none"
