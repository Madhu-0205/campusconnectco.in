            ...
            <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: "Payouts Settled", value: `₹${completedPayoutsVolume.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, icon: ShieldCheck, desc: "Total funds successfully released", color: "text-purple-400" },
                    ].map((card, idx) => (
