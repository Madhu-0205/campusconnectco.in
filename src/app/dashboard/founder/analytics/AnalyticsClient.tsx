...
const FinancialChart = dynamic(() => import("@/components/Analytics/FinancialChart"), {
 ssr: false,
 loading: () => <div className="h-full w-full animate-pulse bg-surface-3/50 rounded-xl"></div>
});
...
export default function AnalyticsDashboard() {
 ...
 { icon: Briefcase, label:"Total Applications", value: data.opportunities.totalApplications.toLocaleString(), sub: `+${data.opportunities.recentApplications30d} last 30 days`, color:"text-primary", bgColor:"bg-primary/10" },
