...
export default function ReportsClient({ summary, chartData, internshipBreakdown }: Props) {
 ...
 { key:"gigs", label:"Total Gigs", icon: Briefcase, color:"text-primary bg-primary/10", value: summary.totalGigs.toLocaleString() },
 ...
 />
 <div className="absolute -top-8 left-1/2 -translate-x-1/2 hidden group-hover:block bg-surface-2 text-[10px] font-black px-2 py-1 rounded-lg whitespace-nowrap z-10">
