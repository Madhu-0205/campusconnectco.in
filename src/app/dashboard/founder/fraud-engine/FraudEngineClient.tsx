...
export default function FraudEngineClient() {
 ...
 <div className="p-3 bg-primary/10 text-primary rounded-2xl shadow-[0_0_30px_rgba(168,85,247,0.2)]">
 ...
 <div className="p-4 bg-primary/10 text-primary rounded-3xl shadow-[0_0_30px_rgba(99,102,241,0.2)] ring-1 ring-white/10 flex items-center justify-center">
 <Lock size={32} />
 </div>
 </div>
