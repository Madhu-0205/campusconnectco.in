...
export default async function EscrowPage() {
 ...
 {[
 { label:"Active Locked Liquidity", value: `₹${lockedVolume.toLocaleString()}`, icon: Lock, desc:"Secured funds for in-progress work", color:"text-primary" },
 ...
 <th className="pb-3 font-black text-right text-primary">Fee Split</th>
 ...
 <td className="py-3.5 text-right font-black text-primary">₹{esc.platformFee.toLocaleString()}</td>
