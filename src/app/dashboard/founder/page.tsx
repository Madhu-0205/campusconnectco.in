...
export default async function FounderDashboard() {
 ...
 <div className="absolute top-[-30%] left-[5%] w-80 h-80 bg-primary/15 blur-[80px] rounded-full" />
 ...
 <Link href="/dashboard/founder/gigs/new" className="px-5 py-2.5 rounded-xl font-black text-sm flex items-center gap-2 transition-colors shadow-lg" style={{ background:"var(--color-primary)", boxShadow:"0 0 28px rgba(31,169,113,0.35)" }}>
 ...
 <div>
 <h4 className="font-black text-foreground group-hover:text-primary transition-colors truncate max-w-50">{gig.title}</h4>
 ...
 <div>
 <h4 className="font-black text-foreground group-hover:text-primary transition-colors truncate max-w-50">{app.applicant?.name ||"User"} applied</h4>
 ...
 <Card className="p-6 rounded-2xl border border-border bg-card backdrop-blur-xl shadow-[0_0_20px_rgba(31,169,113,0.1)] hover:border-primary/40 transition-all">
 ...
 <div className="flex items-start gap-3">
 <span className="w-1.5 h-1.5 rounded-full bg-primary mt-1.5 shrink-0 shadow-[0_0_8px_rgba(139,92,246,0.8)]" />
