  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        >
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <motion.div variants={fadeUp} className="shrink-0">
              <div className="w-24 h-24 rounded-2xl bg-linear-to-br from-violet-600 to-cyan-500 flex items-center justify-center font-black text-4xl shadow-[0_0_40px_rgba(124,58,237,0.3)]">
                {s.name.charAt(0)}
              </div>
            </motion.div>
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 mb-3">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 bg-violet-600 hover:bg-violet-700 font-bold text-sm rounded-xl transition-all shadow-[0_0_20px_rgba(124,58,237,0.4)]"
                  >
                    <Mail size={15} />
                    Hire This Student
                  </a>
        ...
        >
          {[
            { label: "Gigs Completed", value: s.stats.gigsCompleted, icon: <Briefcase size={16} />, color: "text-violet-600", bg: "bg-violet-600/10" },
