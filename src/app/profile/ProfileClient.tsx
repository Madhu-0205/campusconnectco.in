                ...
                <motion.div
                    ...
                    style={{
                        backgroundImage: profile.coverImage
                            ...
                            : "linear-gradient(135deg, #0a0a0f 0%, rgba(124,58,237,0.15) 100%)",
                    }}
                />
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10 pb-20">
                <div className="grid lg:grid-cols-12 gap-12">
                                ...
                                {isEditing ? (
                                    ...
                                    <>
                                        <div>
                                            ...
                                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest border" style={{ background: "rgba(124,58,237,0.10)", color: "var(--color-primary)", borderColor: "rgba(124,58,237,0.20)" }}>
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {/* AI Resume Analyzer */}
                            <section className="rounded-5xl p-8 relative overflow-hidden group" style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(6,182,212,0.08))", border: "1px solid rgba(124,58,237,0.15)" }}>
...
function ProjectCard({ project, onRemove }: { project: Project, onRemove: () => void }) {
    return (
        ...
        >
            ...
            <div className="p-8">
                <h3 className="font-black text-foreground mb-2 group-hover:text-violet-500 transition-colors">{project.title}</h3>
                <p className="dark:text-muted-foreground text-sm font-medium line-clamp-2 leading-relaxed">
