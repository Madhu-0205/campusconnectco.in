  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute top-1/3 right-1/4 w-72 h-72 blur-[130px] rounded-full" style={{ background: "rgba(124,58,237,0.06)" }} />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-14">
        ...
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#7C3AED]/15 border border-[#7C3AED]/30 text-[#A78BFA] text-[11px] font-black uppercase tracking-widest mb-6">
            <BookOpen size={11} />
            Editorial Standards
          </div>
          <h1
          ...
          <div className="relative space-y-4 pl-8 before:absolute before:left-3 before:top-2 before:bottom-2 before:w-px before:bg-white/10">
            {REVIEW_PROCESS.map(({ step, title, desc }) => (
              <div key={step} className="relative">
                <div className="absolute -left-8 top-1 w-6 h-6 rounded-full border border-[#7C3AED]/40 bg-[#7C3AED]/15 flex items-center justify-center">
