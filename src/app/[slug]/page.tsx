...
export default async function SEOLandingPage({ params }: Props) {
 ...
 <Link href={page.primaryCta.href} className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition hover:bg-primary">
 ...
 <article key={card.title} className="group rounded-3xl border border-slate-200 bg-white p-6 transition hover:border-primary/30 hover:shadow-xl">
 <h3 className="text-xl font-semibold text-slate-950">{card.title}</h3>
 <p className="mt-3 text-sm leading-6 text-slate-600">{card.subtitle}</p>
 <Link href={card.url} className="mt-6 inline-flex text-sm font-semibold text-primary transition group-hover:text-primary">
 ...
 <p className="text-sm font-semibold uppercase tracking-[0.22em] text-primary">Related content</p>
 ...
 <li key={link.href}>
 <Link href={link.href} className="block rounded-2xl border border-slate-200 bg-white px-5 py-4 text-base font-semibold text-slate-950 transition hover:border-primary/30 hover:bg-primary">
 {link.label}
 </Link>
 </li>
 ))}
 ...
 <section className="mt-16">
 <header className="mb-8">
 <p className="text-sm font-semibold uppercase tracking-[0.22em] text-primary">FAQs</p>
 ...
 <section className="mt-16 rounded-3xl border border-primary bg-primary p-10 text-white">
 <div className="max-w-3xl">
 <h2 className="text-3xl font-bold tracking-tight">Ready to move forward?</h2>
 <p className="mt-4 text-base leading-7 text-primary">Start with the right student opportunity, build credibility, and hire or apply with confidence.</p>
 <div className="mt-8 flex flex-col gap-3 sm:flex-row">
 <Link href={page.primaryCta.href} className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-primary shadow-lg shadow-black/10 transition hover:bg-slate-100">
 {page.primaryCta.label}
 </Link>
 {page.secondaryCta && (
