...
function JoinPageClient() {
 ...
 {/* Dynamic Background */}
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/40 via-gray-950 to-black pointer-events-none" />
 ...
 <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary to-primary-light flex justify-center items-center shadow-[0_0_20px_rgba(31,169,113,0.4)] group-hover:shadow-[0_0_30px_rgba(31,169,113,0.6)] transition-all">
 ...
 {/* Invitation Badge */}
 <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-xs font-bold text-primary uppercase tracking-wider mb-6 animate-pulse">
 ...
 <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-primary to-primary-light flex items-center justify-center border-2 border-primary/50 shadow-lg">
 ...
 <div className="flex items-start gap-3 bg-primary/10 border border-primary/20 p-3 rounded-xl">
 ...
 <button
 onClick={handleClaim}
 className="w-full mt-8 bg-linear-to-r from-primary to-primary-light hover:from-primary hover:to-primary-light active:scale-[0.98] transition-all font-black py-4 rounded-xl text-white shadow-[0_0_30px_rgba(31,169,113,0.3)] hover:shadow-[0_0_35px_rgba(31,169,113,0.5)] flex items-center justify-center gap-2 group cursor-pointer"
 >
 ...
 <span className="flex items-center gap-1.5">
 <Users size={14} className="text-primary" /> 5,000+ Students
 </span>
 </div>
 </div>
