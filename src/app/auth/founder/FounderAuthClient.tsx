...
export default function FounderSignInPage() {
 ...
 {/* Background glows */}
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-150 h-75 bg-warning/10 text-warning rounded-full blur-3xl" />
 <div className="absolute bottom-0 right-0 w-100 h-75 bg-(--primary)/5 rounded-full blur-3xl" />
