...
export default function SignInPage() {
 ...
 <div className="absolute top-[-20%] left-[-10%] w-150 h-150 bg-primary/20 blur-[150px] rounded-full pointer-events-none" />
 <div className="absolute bottom-[-10%] right-[-5%] w-100 h-100 bg-primary-light/10 blur-[150px] rounded-full pointer-events-none" />
