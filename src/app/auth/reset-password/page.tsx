...
export default function ResetPasswordPage() {
 ...
 className="w-full border border-slate-300 bg-(--surface-2) text-foreground p-3 rounded-xl focus:ring-2 focus:ring-(--primary)/50 focus:border-(--primary) outline-none transition-all pr-12"
 value={password}
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-muted-foreground :text-muted-foreground"
 >
 ...
 <Link
 href="/auth/sign-in"
 className="text-muted-foreground hover:text-(--primary) :text-(--primary) font-semibold transition-colors"
 >
 Back to Sign In
 </Link>
 </div>
