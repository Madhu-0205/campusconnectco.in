...
export default function ForgotPasswordPage() {
 ...
 <h2 className="font-black text-foreground mb-3">Check your inbox</h2>
 ...
 <Link href="/auth/sign-in" className="inline-flex items-center gap-2 font-black text-muted-foreground hover:text-foreground transition-colors">
 ...
 required
 className="w-full pl-10 pr-4 py-3 bg-(--surface-2) border border-border placeholder:text-muted-foreground rounded-xl focus:outline-none focus:ring-2 focus:ring-(--primary)/40 focus:border-(--primary)/40 transition-all text-sm font-medium"
 />
 </div>
 </div>
 <button
 ...
 <Link href="/auth/sign-in" className="inline-flex items-center gap-1.5 font-bold text-muted-foreground hover:text-foreground transition-colors">
