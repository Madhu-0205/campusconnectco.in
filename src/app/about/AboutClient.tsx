...
export default function AboutClient() {
 ...
 <Star size={12} className="fill-[#1FA971]" /> Our Story
 </motion.div>
 ...
 { year:"Late 2024", title:"AI SmartMatch v1", desc:"Integrated AI opportunity matching to connect students to gigs aligned with their skill set. Match rates jumped 3×.", icon: Brain, color:"text-[#1FA971] bg-[#1FA971]/10 border-[#1FA971]/20", align:"left" as const },
 ...
 {[
 { initials:"SW", name:"Sathwik", role:"Founder", tags: ["Vision","Strategy"], color:"bg-linear-to-br from-[#1FA971] to-[#0EA5E9]" },
 { initials:"SU", name:"Suro", role:"CEO", tags: ["Operations","Scale"], color:"bg-linear-to-br from-[#0EA5E9] to-primary-light" },
