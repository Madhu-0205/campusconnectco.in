...
export default async function TopicHubPage({ params }: Props) {
 ...
 className="bg-surface/60 border border-white/5 rounded-3xl p-6 hover:border-primary/30 transition-all flex flex-col justify-between h-full"
 >
 <div className="space-y-3 mb-6">
 <span className="text-xs font-bold text-primary uppercase tracking-wider">{article.category.replace("-","")}</span>
