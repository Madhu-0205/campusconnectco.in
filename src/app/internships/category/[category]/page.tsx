...
export default async function CategoryInternshipsPage({ params }: Props) {
 ...
 {cat.name} <span className="text-transparent bg-clip-text bg-linear-to-r from-primary to-primary">Internships & Campus Gigs</span>
 </h1>
 ...
 className="px-2.5 py-1 rounded-lg bg-primary/10 border border-primary/20 text-primary text-xs font-semibold hover:border-primary transition-colors"
 >
 {sk}
 </Link>
 ))}
 ...
 className="inline-block px-5 py-2.5 rounded-xl bg-primary hover:bg-primary text-white font-bold text-sm transition-all"
 >
 ...
 <div
 key={internship.id}
 className="bg-surface/60 border border-white/5 rounded-3xl p-5 hover:border-primary/20 transition-all flex flex-col justify-between h-52"
 >
 <div>
 ...
 return (
 <div key={student.id} className="bg-surface/80 border border-white/5 rounded-2xl p-4 space-y-3 hover:border-cyan-500/20 transition-all">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-lg bg-linear-to-br from-primary to-primary flex items-center justify-center font-black text-xs text-white">
 {avatarLetter}
 </div>
 ...
 {/* Escrow Banner */}
 <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/10 rounded-3xl p-5 space-y-2.5">
