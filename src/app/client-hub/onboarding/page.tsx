...
export default function ClientOnboardingPage() {
 ...
 <Card className="border border-white/10 bg-surface-2/50 backdrop-blur-xl shadow-2xl rounded-3xl p-8">
 ...
 className="w-full px-5 py-3 rounded-xl border border-white/10 bg-surface-3/50 focus:bg-surface-3 focus:ring-2 focus:ring-blue-500/50 outline-none transition-all font-medium text-white placeholder:text-slate-500"
 />
 </div>
