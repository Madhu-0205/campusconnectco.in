...
const TIERS = [
 ...
 { name:"Legend", icon:"👑", req:"25+ onboards", perRef:"₹250 bonus", color:"#1FA971", unlocks:"Campus Legend title + Internship track" },
]
...
export function AmbassadorClient({ nonce }: { nonce?: string }) {
 ...
 <div className="absolute top-1/4 left-1/4 w-96 h-96 blur-[150px] rounded-full" style={{ background:"rgba(31,169,113,0.07)" }} />
...
"url":"https://campusconnectco.in",
 ...
 style={{ background:"linear-gradient(135deg, #1FA971, #FF4500)", boxShadow:"0 8px 32px rgba(31,169,113,0.35)" }}
 >
 Apply Now — Free
 </a>
 <a
 ...
 style={{ background:"var(--color-surface, #0F1624)", border:"1px solid rgba(31,169,113,0.2)" }}
 >
 <div className="p-6 border-b border-white/5" style={{ background:"linear-gradient(135deg, rgba(31,169,113,0.1), rgba(255,69,0,0.06))" }}>
 ...
 className="w-full text-sm text-slate-200 placeholder-slate-600 rounded-xl px-4 py-3 outline-none focus:border-[#1FA971]/50 transition-all"
 ...
 style={{ background:"linear-gradient(135deg, #1FA971, #FF4500)", boxShadow:"0 8px 32px rgba(31,169,113,0.3)" }}
 >
