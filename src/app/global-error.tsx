...
export default function GlobalError({
 ...
 <button
 onClick={() => reset()}
 className="w-full h-12 bg-primary hover:bg-primary text-white font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-primary/20 transition-all cursor-pointer"
 >
