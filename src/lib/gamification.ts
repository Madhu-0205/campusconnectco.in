...
export const BADGES = [
 ...
 { slug:"gigs-25", name:"Seasoned Pro", icon:"💎", color:"#1FA971", tier:"GOLD", xpReward: 800, rarity:"RARE", requirement: { type:"gig_count", value: 25 }, description:"Completed 25 gigs" },
 ...
 { slug:"earn-1l", name:"Lakhpati", icon:"🏆", color:"#1FA971", tier:"PLATINUM", xpReward: 3000, rarity:"EPIC", requirement: { type:"earned_inr", value: 100000 }, description:"Earned ₹1 Lakh total" },
 // Streak badges
